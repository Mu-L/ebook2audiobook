...
from lib.conf import prog_version, default_device, components_dir, devices, default_output_format, default_output_channel, min_python_version, max_python_version
