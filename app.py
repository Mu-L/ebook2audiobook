...
Tip: to add of silence (1.4 seconds) into your text just use "###" or "[pause]".
    ...
    if not 'help' in args:
        ...
        from lib.functions import SessionContext, SessionTracker, context, context_tracker, active_sessions, cleanup_garbage, convert_ebook_batch, convert_ebook, build_interface, gr_restore_session
        cleanup_garbage()
