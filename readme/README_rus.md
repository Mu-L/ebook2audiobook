...
**Ознакомьтесь с нашим другим репозиторием, посвящённым автоматическому добавлению SML в вашу электронную книгу -> [E2A-SML](./tools/E2A-SML)**
...
## ***** ДОРОЖНАЯ КАРТА *****
- Все функции открыты для публичного вклада ⭐
- Любая помощь от людей, говорящих на любом из поддерживаемых языков, чтобы помочь нам улучшить модели ⭐
- [x] Предпросмотр блоков/глав перед началом преобразования
- [ ] Редактирование по преобразованному предложению для точечного изменения текста
- [x] Интеграция тегов SML для голоса, паузы, прерывания и других изменений 
- [x] Информация о параметрах -h -help на разных языках
- [x] Сканирование OCR для PDF / JPG / BMP / PNG / TIFF
- [x] Папка блокнотов [Talked about here](https://github.com/DrewThomasson/ebook2audiobookXTTS/issues/5#issuecomment-2408773254)
- [x] Сделать так, чтобы разбиение китайского текста не разбивало слова, и улучшить тайминг пауз [Talked about here](https://github.com/DrewThomasson/ebook2audiobookXTTS/issues/18#issuecomment-2401154894)
- [x] Dockerfile
- [x] Docker compose
- [x] Podman compose   
- [x] Блокнот Kaggle
- [x] Блокнот Google Colab
- [ ] [Создать приложение для iOS](https://github.com/DrewThomasson/ebook2audiobook/pull/35#issuecomment-2496495212)
