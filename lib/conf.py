...
os.environ['PYTORCH_CUDA_ALLOC_CONF'] = 'max_split_size_mb:128,garbage_collect_after_forward_pass:1,expandable_segments:True'
os.environ['export TORCH_USE_CUDA_DSA'] = '1'
