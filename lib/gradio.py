...
def build_interface(args:dict)->gr.Blocks:
    try:
        ...
        with gr.Blocks(title=title, delete_cache=(604800, 86400)) as app:
                            ...
                            with gr.Column(elem_id='gr_col_1', elem_classes=['gr-col'], scale=3):
                                ...
                                with gr_group_voice_file:
                                    ...
                                    with gr_row_voice_player:
                                        gr_voice_player_hidden = gr.Audio(elem_id='gr_voice_player_hidden', type='filepath', interactive=False, waveform_options=gr.WaveformOptions(show_recording_waveform=False), buttons=['share'], container=False, visible='hidden', show_label=False, scale=0, min_width=60)
            ...
            gr_modal = gr.HTML(visible=False, padding=True)
            gr_glassmask = gr.HTML(gr_glassmask_msg, elem_id='gr_glassmask', elem_classes=['gr-glass-mask'], padding=True)
