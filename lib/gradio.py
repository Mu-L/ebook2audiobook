                        ...
                        with gr.Row(elem_id='gr_row_tab_main'):
                            with gr.Column(elem_id='gr_col_1', elem_classes=['gr-col'], scale=3):
                                with gr.Group(elem_id='gr_group_ebook_src', elem_classes=['gr-group']):
                                    ...
                                    gr_ebook_textarea = gr.Textbox(label=ebook_mode_labels['text'], elem_id='gr_ebook_textarea', visible=False, show_label=True, lines=8, max_lines=8, max_length=max_ebook_textarea_length)
