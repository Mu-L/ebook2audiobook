...
models = {
    "internal": {
        ...
        "sub": {
            ...
            "ca_ES": ["ca_ES-upc_pau-medium", "ca_ES-upc_ona-medium"],
            ...
            "de_DE": ["de_DE-thorsten-high", "de_DE-eva_k-high"],
            ...
            "pt_PT": ["pt_PT-tugão-medium", "pt_PT-faber-medium"],
            "ro_RO": ["ro_RO-mihai-medium", "ro_RO-mihai-medium"],
            "ru_RU": ["ru_RU-denis-medium", "ru_RU-irinia-medium"],
            ...
            "tr_TR": ["tr_TR-fettah-medium", "tr_TR-dfki-medium"],
            "uk_UA": ["uk_UA-ukrainian_tts-medium", "uk_UA-lada-x_low"],
            "ur_PK": ["ur_PK-umer-medium", "ur_PK-fasih-medium"],
