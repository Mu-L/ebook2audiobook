    ...
    def convert(self, sentence_file:str, sentence:str, **kwargs)->tuple:
        try:
            ...
            if self.engine:
                ...
                use_zs = self.params['current_voice'] is not None and current_voice_stem not in default_engine_settings[self.tts_engine]['voices'] and current_voice_stem != self.params['custom_model']
