        ...
        if session['language'] in year_to_decades_languages:
            try:
                ...
                if stanza_nlp:
                    ...
                    use_gpu = True if (session['device'] == devices['CUDA']['proc'] and not devices['JETSON']['found'] and devices['CUDA']['found']) or (session['device'] == devices['ROCM']['proc'] and devices['ROCM']['found']) or (session['device'] == devices['XPU']['proc'] and devices['XPU']['found'])else False
