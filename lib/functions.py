...
def web_interface(args, ctx):
    ...
    with gr.Blocks(theme=theme, title=title, css=header_css, delete_cache=(86400, 86400)) as app:
        ...
        def show_rating(tts_engine):
            ...
            return f"""
            <span style='display: inline-flex; white-space:nowrap; padding:0 10px; font-size:14px'>TTS Engine&nbsp;&nbsp;&nbsp;</span>
            <div style='margin:0; padding:0; font-size:12px; line-height:1.2; height:auto; display:inline-flex; flex-wrap:wrap; align-items:center; gap:6px 12px;'>
