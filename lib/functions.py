                        ...
                        with gr.Column(elem_id='gr_col_1', elem_classes=['gr-col'], scale=3):
                            ...
                            with gr_group_voice_file:
                                ...
                                with gr_row_voice_player:
                                    gr_voice_player = gr.Audio(elem_id='gr_voice_player', elem_classes=['gr-voice-player'], type='filepath', interactive=False, waveform_options=gr.WaveformOptions(show_recording_waveform=False), show_download_button=False, container=False, visible=False, show_share_button=False, show_label=False, scale=0, min_width=60)
