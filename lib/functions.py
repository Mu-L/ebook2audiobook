...
def web_interface(args, ctx):
    ...
    header_css = '''
        <style>
            ...
            ////////////////////
            #gr_ebook_file, #gr_custom_model_file, #gr_voice_file:has(button:disabled), #gr_ebook_file:has(button:disabled), #gr_custom_model_fil, #gr_ebook_file:has(button:disabled) {
