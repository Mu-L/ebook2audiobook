                ...
                with gr_tab_main:
                    with gr.Row(elem_id='gr_row_tab_main'):
                        ...
                        with gr.Column(elem_id='gr_col_2', elem_classes=['gr-col'], scale=3):
                            with gr.Group(elem_id='gr_group_engine', elem_classes=['gr-group']):
                                ...
                                with gr.Row(elem_id='gr_row_output_format'):
                                    ...
                                    with gr.Group(elem_id='gr_group_output_split'):
                                        ...
                                        with gr_row_output_split_hours:
                                            gr_output_split_hours_markdown = gr.Markdown(elem_id='gr_output_split_hours_markdown', value='<div style="background: var(--block-background-fill); font-size: 12px; width:100%; text-align:center; vertical-align: middle; padding-top:15px; padding-bottom:13px; white-space: nowrap">Max Hours<br/>/Part</div>')
        ...
        def show_rating(tts_engine):
            ...
            <div style="display:flex; justify-content:space-between">
                ...
                <table style="border-collapse: collapse; margin: 0; padding: 0; border: none; font-size: 12px;">
                  <tr>
                    <td style="padding: 0; margin: 0; border: none;"><b>GPU VRAM:</b> {color_box(rating["GPU VRAM"])}</td>
                    <td style="padding: 0; margin: 0; border: none;"><b>CPU:</b> {yellow_stars(rating["CPU"])}</td>
                    <td style="padding: 0; margin: 0; border: none;"><b>RAM:</b> {color_box(rating["RAM"])}</td>
                    <td style="padding: 0; margin: 0; border: none;"><b>Realism:</b> {yellow_stars(rating["Realism"])}</td>
                  </tr>
                </table>
            </div>
            '''
